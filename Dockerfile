...
# Comment out ENTRYPOINT if you want to run deno straight with docker. CMD and ENTRYPOINT do not like each other in this case. Either run Deno or access (fish)shell and run deno manually.
